...
Anteriormente, hemos aprendido prácticas de endurecimiento de la red y prácticas de endurecimiento relacionadas con la seguridad de la red, como el filtrado de puertos, los privilegios de acceso a la red y el cifrado en las redes.
...
Para utilizar la plantilla para este elemento del curso, haga clic en el siguiente enlace:

[Security-risk-assessment-report.pdf](docs/Security-risk-assessment-report.pdf)

[Informe-de-evaluación-de-riesgos-de-seguridad.pdf](docs/Informe-de-evaluacin-de-riesgos-de-seguridad.pdf)
...
Para utilizar los materiales de apoyo para este tema del curso, haga clic en el siguiente enlace:

[Network-hardening-tools.pdf](docs/Network-hardening-tools.pdf)

[Herramientas-de-endurecimiento-de-la-red.pdf](docs/Herramientas-de-endurecimiento-de-la-red.pdf)
...
Usted ha recomendado una o dos prácticas de endurecimiento de seguridad para ayudar a evitar que esto vuelva a ocurrir en el futuro. Explique por qué la herramienta o método de endurecimiento de seguridad seleccionado es eficaz para abordar la vulnerabilidad.
